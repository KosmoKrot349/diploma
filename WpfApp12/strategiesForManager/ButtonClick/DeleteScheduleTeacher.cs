...
{
    class DeleteScheduleTeacher:IButtonClick
    {
        ManagerWindow windowObj;

        public DeleteScheduleTeacher(ManagerWindow windowObj)
        {
        ...
        public void ButtonClick()
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = "delete from raspisanie where prepid =" + teacherID + " and lesson_number = " + lessonNumber + " and day=" + (day + 1) + " and date='" + windowObj.dateMonday.AddDays(day).ToShortDateString().Replace('.', '-') + "'";
