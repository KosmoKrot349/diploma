...
namespace WpfApp12.strategiesForManager.ButtonClick
{
    class DeleteScheduleTeacher:IButtonClick
    {
        ...
        public DeleteScheduleTeacher(DirectorWindow windowObj)
        {
        ...
        public void ButtonClick()
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = "delete from raspisanie where prepid =" + prep + " and lesson_number = " + lesNum + " and day=" + (day + 1) + " and date='" + windowObj.dateMonday.AddDays(day).ToShortDateString().Replace('.', '-') + "'";
