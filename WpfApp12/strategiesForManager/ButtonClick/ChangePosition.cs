...
namespace WpfApp12.strategiesForManager.ButtonClick
{
    class ChangePosition:IButtonClick
    {
        ...
        public void ButtonClick()
        {
            ...
            if (Convert.ToInt32(windowObj.Chanedays1.Text) > 31 || Convert.ToInt32(windowObj.Chanedays2.Text) > 29 || Convert.ToInt32(windowObj.Chanedays3.Text) > 31 || Convert.ToInt32(windowObj.Chanedays4.Text) > 30 || Convert.ToInt32(windowObj.Chanedays5.Text) > 31 || Convert.ToInt32(windowObj.Chanedays6.Text) > 30 || Convert.ToInt32(windowObj.Chanedays7.Text) > 31 || Convert.ToInt32(windowObj.Chanedays8.Text) > 31 || Convert.ToInt32(windowObj.Chanedays9.Text) > 30 || Convert.ToInt32(windowObj.Chanedays10.Text) > 31 || Convert.ToInt32(windowObj.Chanedays11.Text) > 30 || Convert.ToInt32(windowObj.Chanedays12.Text) > 31) { System.Windows.Forms.MessageBox.Show("Дни в месяцах указаны не верно"); return; }
            try
            {
